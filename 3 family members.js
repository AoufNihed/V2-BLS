...
function TheBigBro() {
    ...
    if (table !== "") {
        ...
        if(document.getElementById("app_date").value.length === 0 && finDate !== "") {
            ...
            var firstNames = ["first_Names_1", "first_Names_2", "first_Names_3"];
            var births = ["yyyy-mm-aa", "yyyy-mm-aa", "yyyy-mm-aa"]; // Date Of Birth
            var passNumbers = ["KN0000000", "LF0000000", "BH0000000"]; // Passport Number
            var issueDates = ["yyyy-mm-aa", "yyyy-mm-aa", "yyyy-mm-aa"]; // Passport Issue Date
            var expiryDates = ["yyyy-mm-aa", "yyyy-mm-aa", "yyyy-mm-aa"]; // Passport Expiry Date
            var pptissuePalaces = ["city Name", "city Name", "city Name"]; // Passport Issue Place
